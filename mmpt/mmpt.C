...
gpT->SetLineStyle(9);
//gpT->SetTitle("Mean of mean pT");
gpT->GetXaxis()->SetTitle("Counts");
gpT->GetYaxis()->SetTitle("Mean of Mean pT");
...
auto legend = new TLegend(0.1,0.7,0.48,0.9);
   ...
   legend->AddEntry("gpT","1 observation of <<p>>","P");
   legend->Draw();
}
